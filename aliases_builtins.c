...
/**
 * shellby_alias - Builtins command that either prints all aliases, specific
 * sets an alias.
...
/**
 * print_alias - This Prints the aliases in the format name='value'.
 ...
 * matching aliases with their values.
