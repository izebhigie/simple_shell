...
/**
 * struct list_s - A new type of struct defining a linked lists.
 * @dir : A path directory
...
/**
 * struct alias_s - A new defining struct aliases.
 * @name: The alias name.
